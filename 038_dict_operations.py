...
def count_words_by_length(words):
  counted_words_length = {}
  for word in words:
    word_length = len(word)
    if word_length not in counted_words_length:
      counted_words_length[word_length] = 1
    else:
      counted_words_length[word_length] = counted_words_length[word_length] + 1
  return counted_words_length    
